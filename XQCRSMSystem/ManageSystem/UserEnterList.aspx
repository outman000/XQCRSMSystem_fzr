<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEnterList.aspx.cs" Inherits="XQCRSMSystem.ManageSystem.UserEnterList" %>
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md3">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                             <asp:DropDownList  name="ddlStatus" id="ddlStatus" style=""  runat="server">
                                <asp:ListItem Value="99">-请选择-</asp:ListItem>
                                <asp:ListItem Value="0">绿灯通过</asp:ListItem>
                                <asp:ListItem Value="8">黄灯未登记</asp:ListItem>
                                <asp:ListItem Value="9">红灯不可入</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>          

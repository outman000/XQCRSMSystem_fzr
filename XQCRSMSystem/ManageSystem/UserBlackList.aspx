<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserBlackList.aspx.cs" Inherits="XQCRSMSystem.ManageSystem.UserBlackList" %>
...
<body>
    <form id="form1" runat="server">
        <div class="layui-container">
            ...
            <h2 class="title">黑名单列表</h2>
            <div class="layui-row">
                <div class="layui-col-md3">
                    <div class="layui-form-item">
                        <label class="layui-form-label">姓名</label>
                        <div class="layui-input-block">
                            <asp:TextBox ID="tbName"  runat="server" CssClass="layui-input"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="layui-col-md3">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <asp:TextBox ID="tbIDCard"  runat="server" CssClass="layui-input"></asp:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="layui-row textc" style="margin-left: 245px;">
                ...
                <div class="layui-col-md2 btndiv">
                    <asp:Button ID="btnAdd" runat="server" Text="新建" CssClass="layui-btn  layui-btn-sm " OnClick="btnAdd_Click"  Visible="false"/>
                </div>
                <div class="layui-col-md2 btndiv">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="layui-table" BorderColor="ActiveCaption"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="手机号" ItemStyle-Width="6%" HeaderStyle-Width="6%" DataField="Mobile"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                        <asp:TemplateField HeaderText="操作" ItemStyle-Width="8%" HeaderStyle-Width="8%" ItemStyle-HorizontalAlign="Center" Visible="false">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lID" runat="server" Text='<%#Eval("ID")%>'  Visible="false" ></asp:Label>
                                <asp:LinkButton ID="lCancel" OnClick="lCancel_Click"  style='color: Blue' runat="server">取消黑名单</asp:LinkButton>
                            </ItemTemplate>
                            <HeaderStyle Width="8%" />
                        </asp:TemplateField>
                    </Columns>

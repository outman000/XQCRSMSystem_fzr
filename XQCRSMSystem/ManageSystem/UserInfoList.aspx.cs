...
namespace XQCRSMSystem.ManageSystem
{
    public partial class UserInfoList : System.Web.UI.Page
    {
        ...
        protected void GridLoad()
        {
            ...
            string sql = " select  *  from  XQCR_Personnel_Info where 1=1 ";
            ...
            {
                sql += " and ResidentOrVisitor=@ResidentOrVisitor ";
            ...
            {
                sql += "  and ( Name like @keys or CertificateID like @keys or Mobile like @keys or Address like @keys ) ";
        ...
        protected void LDetail_Click(object sender, EventArgs e)
        {
            int rowIndex = ((GridViewRow)((LinkButton)sender).NamingContainer).RowIndex;
            //该行对应的ID
            string id = GridView1.DataKeys[rowIndex].Values["ID"].ToString();
            Response.Redirect("UserEnterInfo.aspx?ID=" + id);

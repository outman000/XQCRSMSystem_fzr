<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropertyList.aspx.cs" Inherits="XQCRSMSystem.ManageSystem.PropertyList" %>
    ...
    <form id="form1" runat="server">
        <div class="layui-container">
            ...
            <div class="layui-row textc" style="margin-left: 245px;">
                ...
                <div class="layui-col-md2 btndiv">
                    <asp:Button ID="btnAdd" runat="server" Text="新建" CssClass="layui-btn  layui-btn-sm " OnClick="btnAdd_Click" />
                </div>
                <div class="layui-col-md2 btndiv">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="layui-table" BorderColor="ActiveCaption"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="姓名" ItemStyle-Width="6%" HeaderStyle-Width="6%" DataField="UserName"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField HeaderText="账号" ItemStyle-Width="8%" HeaderStyle-Width="8%" DataField="UserID"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField HeaderText="手机号" ItemStyle-Width="6%" HeaderStyle-Width="6%" DataField="Mobile"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                        <asp:TemplateField HeaderText="重置密码" ItemStyle-Width="8%" HeaderStyle-Width="8%" ItemStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lID" runat="server" Text='<%#Eval("ID")%>'  Visible="false" ></asp:Label>
                                <asp:LinkButton ID="lSetPW" OnClick="lSetPW_Click"  style='color: Blue' runat="server">重置密码</asp:LinkButton>
                            </ItemTemplate>
                            <HeaderStyle Width="8%" />
                        </asp:TemplateField>
                    </Columns>
